...
func TestAPICmdAuthRequiredMatrixErrorsWithoutConfig(t *testing.T) {
	...
	commands := [][]string{
		...
		{"entities", "get", "e1"},
		{"entities", "create", "--input", `{"scopes":["public"],"name":"Entity","type":"person","status":"active","tags":[],"metadata":{}}`},
		{"entities", "update", "e1", "--input", `{"metadata":{"phase":"updated"}}`},
		{"entities", "search", "--input", `{"board":"nebula-core"}`},
		{"entities", "history", "e1"},
		...
		{"context", "get", "c1"},
		{"context", "create", "--input", `{"title":"Ctx","source_type":"note","content":"x","scopes":["public"],"tags":[],"metadata":{}}`},
		{"context", "update", "c1", "--input", `{"metadata":{"phase":"updated"}}`},
		{"context", "link", "c1", "--entity-id", "e1"},
		{"relationships", "query", "--param", "limit=1"},
		{"relationships", "for-source", "entity", "e1"},
		{"relationships", "create", "--input", `{"source_type":"entity","source_id":"e1","target_type":"entity","target_id":"e2","relationship_type":"related-to","properties":{}}`},
		{"relationships", "update", "r1", "--input", `{"properties":{"phase":"updated"}}`},
		{"jobs", "query", "--param", "limit=1"},
		{"jobs", "get", "j1"},
		{"jobs", "create", "--input", `{"title":"Job","status":"pending","priority":"low","metadata":{}}`},
		{"jobs", "update", "j1", "--input", `{"metadata":{"phase":"updated"}}`},
